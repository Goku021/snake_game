...
# create a calculator that has 3 buttons --> one for the number 2 , one for the number 6, and another for the number 12,
# When the user presses an equal button, it should display the sum of the three numbers (20) in a label